...
final class AuthController {
    ...
    /// Opens an ASWebAuthenticationSession to sign in with the given OAuth provider.
    /// The provider must be enabled in the Supabase dashboard, and the redirect URL
    /// scheme below must be listed under the project's "Redirect URLs".
